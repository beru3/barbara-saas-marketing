...
const NEW_LINES = [
  ...
  "- [ ] `gen-20260730-2` 今年7月の猛暑で通院を後回しにした患者さんが、お盆をはさんで2ヶ月続けて来なければ、そのまま戻らない方も出てきます。慢性疾患の方が10人来なくなると、年間でおよそ84万円。夏を「仕方ない季節」にしない院には、理由があります。→ https://note.com/furuie_akihiro/n/n74dfb606526a",
  "- [ ] `gen-20260730-3` 明日から8月。お盆前後でリズムが崩れた患者さんが、そのまま「また今度」になるケースが毎年あります。その方々が1人でも来なくなった場合、年間の差はいくらでしょうか。先生の院の再来院率を一度計算してみると、見え方が変わります。→ https://note.com/furuie_akihiro/n/nba0c87821607",
];
